 ...
 */
final class Version20220227005847 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE content_list_product (id INT AUTO_INCREMENT NOT NULL, product_id INT NOT NULL, INDEX IDX_B8DD51F4584665A (product_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
